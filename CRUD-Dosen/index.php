      ...
      <div class="card mt-3">
          ...
          <button type="button" class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#modalTambah">
              ...
              <table class="table table-bordered table-striped tabel-hover">
                  ...
                  $no = 1;
                  $tampil = mysqli_query($koneksi, "SELECT * FROM dsn ORDER BY id ASC");
                  ...
                  ?>
                      ...
                      <div class="modal fade" id="modalUbah<?= $no ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <h5 class="modal-title fs-5" id="staticBackdropLabel">Form Data Dosen</h5>
                                    ...
                                    <form method="POST" action="aksi_crud.php">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="tnidn" value="<?= $data['nidn'] ?>" placeholder="Masukkan NIDN Anda!">
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label">Jenjang Pendidikan</label>
                                                <select class="form-select" name="tjenpen">
                                                    <option value="<?= $data['jenpen'] ?>"><?= $data['jenpen'] ?></option>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="aksi_crud.php">
                                        ...
                                        <h5 class="text-center"> Apakah Anda yakin akan menghapus data ini? <br>
                                            <span class="text-danger"><?= $data['nama'] ?> - <?= $data['nidn'] ?></span>
                                        </h5>
                    ...
                    <form method="POST" action="aksi_crud.php">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="tnidn" placeholder="Masukkan NIDN Anda!">
                            </div>
